...
/**
 * An example interface for interpreting a critter program. This is just a
...
public interface Interpreter
{
     ...
     * 
     * @param p
     * @return a result containing the action to be performed; the action may be
     *         null if the maximum number of rules per turn was exceeded.
     */
