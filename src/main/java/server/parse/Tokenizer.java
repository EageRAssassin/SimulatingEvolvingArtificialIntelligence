...
import static server.parse.TokenType.ARR;
import static server.parse.TokenType.ASSIGN;
import static server.parse.TokenType.DIV;
import static server.parse.TokenType.EQ;
import static server.parse.TokenType.GE;
import static server.parse.TokenType.GT;
import static server.parse.TokenType.LBRACE;
import static server.parse.TokenType.LBRACKET;
import static server.parse.TokenType.LE;
import static server.parse.TokenType.LPAREN;
import static server.parse.TokenType.LT;
import static server.parse.TokenType.MINUS;
import static server.parse.TokenType.MUL;
import static server.parse.TokenType.NE;
import static server.parse.TokenType.PLUS;
import static server.parse.TokenType.RBRACE;
import static server.parse.TokenType.RBRACKET;
import static server.parse.TokenType.RPAREN;
import static server.parse.TokenType.SEMICOLON;
...
import server.parse.Token.EOFToken;
import server.parse.Token.ErrorToken;
...
public class Tokenizer implements Iterator<Token>
{
    ...
    private Token curTok = new ErrorToken(
            "Tokenizer has not yet begun reading", -1);
